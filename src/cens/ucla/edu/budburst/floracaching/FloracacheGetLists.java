...
public class FloracacheGetLists extends AsyncTask<String, Integer, Void> {
	...
	protected void onPreExecute() {
		...
		noti = new Notification(android.R.drawable.stat_sys_download, "Start downloading - Floracache Lists", System.currentTimeMillis());
		noti.flags |= Notification.FLAG_AUTO_CANCEL;
		
		PendingIntent contentIntent = PendingIntent.getActivity(mContext, 0, null, PendingIntent.FLAG_CANCEL_CURRENT);
		
		noti.setLatestEventInfo(mContext, "Project Budburst", "Downloading floracache lists", contentIntent);
	...
	protected void onPostExecute(Void unused) {
		noti = new Notification(R.drawable.compass_default, "Download complete - Floracache Lists", System.currentTimeMillis());
		noti.flags |= Notification.FLAG_AUTO_CANCEL;
		
		PendingIntent contentIntent = PendingIntent.getActivity(mContext, 0, null, PendingIntent.FLAG_CANCEL_CURRENT);
		
		noti.setLatestEventInfo(mContext, "Project Budburst", "Successfully download floracache lists", contentIntent);
